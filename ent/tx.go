...
func (tx *Tx) init() {
	...
	tx.AttributeValueBool = NewAttributeValueBoolClient(tx.config)
	tx.AttributeValueNum = NewAttributeValueNumClient(tx.config)
	tx.AttributeValueString = NewAttributeValueStringClient(tx.config)
	tx.AttributeVariantNum = NewAttributeVariantNumClient(tx.config)
	tx.AttributeVariantString = NewAttributeVariantStringClient(tx.config)
