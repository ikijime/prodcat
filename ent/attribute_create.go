...
func (ac *AttributeCreate) SetType(s string) *AttributeCreate {
	ac.mutation.SetType(s)
	return ac
}

// AddAttributeValuesBoolIDs adds the "attributeValuesBool" edge to the AttributeValueBool entity by IDs.
func (ac *AttributeCreate) AddAttributeValuesBoolIDs(ids ...int) *AttributeCreate {
	ac.mutation.AddAttributeValuesBoolIDs(ids...)
	return ac
}

// AddAttributeValuesBool adds the "attributeValuesBool" edges to the AttributeValueBool entity.
func (ac *AttributeCreate) AddAttributeValuesBool(a ...*AttributeValueBool) *AttributeCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return ac.AddAttributeValuesBoolIDs(ids...)
}

// AddAttributeVariantsStringIDs adds the "attributeVariantsString" edge to the AttributeVariantString entity by IDs.
func (ac *AttributeCreate) AddAttributeVariantsStringIDs(ids ...int) *AttributeCreate {
	ac.mutation.AddAttributeVariantsStringIDs(ids...)
	return ac
}

// AddAttributeVariantsString adds the "attributeVariantsString" edges to the AttributeVariantString entity.
func (ac *AttributeCreate) AddAttributeVariantsString(a ...*AttributeVariantString) *AttributeCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return ac.AddAttributeVariantsStringIDs(ids...)
}

// AddAttributeVariantsNumIDs adds the "attributeVariantsNum" edge to the AttributeVariantNum entity by IDs.
func (ac *AttributeCreate) AddAttributeVariantsNumIDs(ids ...int) *AttributeCreate {
	ac.mutation.AddAttributeVariantsNumIDs(ids...)
	return ac
}

// AddAttributeVariantsNum adds the "attributeVariantsNum" edges to the AttributeVariantNum entity.
func (ac *AttributeCreate) AddAttributeVariantsNum(a ...*AttributeVariantNum) *AttributeCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return ac.AddAttributeVariantsNumIDs(ids...)
}
...
func (ac *AttributeCreate) check() error {
	...
	if _, ok := ac.mutation.Description(); !ok {
		return &ValidationError{Name: "description", err: errors.New(`ent: missing required field "Attribute.description"`)}
	}
	if _, ok := ac.mutation.GetType(); !ok {
		return &ValidationError{Name: "type", err: errors.New(`ent: missing required field "Attribute.type"`)}
	}
	return nil
}
...
func (ac *AttributeCreate) createSpec() (*Attribute, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.AttributeValuesBoolIDs(); len(nodes) > 0 {
	...
	if nodes := ac.mutation.AttributeVariantsStringIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := ac.mutation.AttributeVariantsNumIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
