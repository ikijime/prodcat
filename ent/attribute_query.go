...
type AttributeQuery struct {
	...
	withAttributeValuesBool     *AttributeValueBoolQuery
	withAttributeVariantsString *AttributeVariantStringQuery
	withAttributeVariantsNum    *AttributeVariantNumQuery
...
// QueryAttributeValuesBool chains the current query on the "attributeValuesBool" edge.
func (aq *AttributeQuery) QueryAttributeValuesBool() *AttributeValueBoolQuery {
	query := (&AttributeValueBoolClient{config: aq.config}).Query()
...
// QueryAttributeVariantsString chains the current query on the "attributeVariantsString" edge.
func (aq *AttributeQuery) QueryAttributeVariantsString() *AttributeVariantStringQuery {
	query := (&AttributeVariantStringClient{config: aq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := aq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryAttributeVariantsNum chains the current query on the "attributeVariantsNum" edge.
func (aq *AttributeQuery) QueryAttributeVariantsNum() *AttributeVariantNumQuery {
	query := (&AttributeVariantNumClient{config: aq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := aq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (aq *AttributeQuery) Clone() *AttributeQuery {
	...
	return &AttributeQuery{
		...
		withAttributeValuesBool:     aq.withAttributeValuesBool.Clone(),
		withAttributeVariantsString: aq.withAttributeVariantsString.Clone(),
		withAttributeVariantsNum:    aq.withAttributeVariantsNum.Clone(),
...
// WithAttributeValuesBool tells the query-builder to eager-load the nodes that are connected to
// the "attributeValuesBool" edge. The optional arguments are used to configure the query builder of the edge.
func (aq *AttributeQuery) WithAttributeValuesBool(opts ...func(*AttributeValueBoolQuery)) *AttributeQuery {
	query := (&AttributeValueBoolClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withAttributeValuesBool = query
	return aq
}

// WithAttributeVariantsString tells the query-builder to eager-load the nodes that are connected to
// the "attributeVariantsString" edge. The optional arguments are used to configure the query builder of the edge.
func (aq *AttributeQuery) WithAttributeVariantsString(opts ...func(*AttributeVariantStringQuery)) *AttributeQuery {
	query := (&AttributeVariantStringClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withAttributeVariantsString = query
	return aq
}

// WithAttributeVariantsNum tells the query-builder to eager-load the nodes that are connected to
// the "attributeVariantsNum" edge. The optional arguments are used to configure the query builder of the edge.
func (aq *AttributeQuery) WithAttributeVariantsNum(opts ...func(*AttributeVariantNumQuery)) *AttributeQuery {
	query := (&AttributeVariantNumClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withAttributeVariantsNum = query
	return aq
}
...
func (aq *AttributeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Attribute, error) {
	var (
		...
		_spec       = aq.querySpec()
		loadedTypes = [3]bool{
			aq.withAttributeValuesBool != nil,
			aq.withAttributeVariantsString != nil,
			aq.withAttributeVariantsNum != nil,
		}
	)
	...
	if query := aq.withAttributeValuesBool; query != nil {
		if err := aq.loadAttributeValuesBool(ctx, query, nodes,
			func(n *Attribute) { n.Edges.AttributeValuesBool = []*AttributeValueBool{} },
			func(n *Attribute, e *AttributeValueBool) {
				n.Edges.AttributeValuesBool = append(n.Edges.AttributeValuesBool, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := aq.withAttributeVariantsString; query != nil {
		if err := aq.loadAttributeVariantsString(ctx, query, nodes,
			func(n *Attribute) { n.Edges.AttributeVariantsString = []*AttributeVariantString{} },
			func(n *Attribute, e *AttributeVariantString) {
				n.Edges.AttributeVariantsString = append(n.Edges.AttributeVariantsString, e)
			}); err != nil {
			return nil, err
		}
	}
	if query := aq.withAttributeVariantsNum; query != nil {
		if err := aq.loadAttributeVariantsNum(ctx, query, nodes,
			func(n *Attribute) { n.Edges.AttributeVariantsNum = []*AttributeVariantNum{} },
			func(n *Attribute, e *AttributeVariantNum) {
				n.Edges.AttributeVariantsNum = append(n.Edges.AttributeVariantsNum, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (aq *AttributeQuery) loadAttributeValuesBool(ctx context.Context, query *AttributeValueBoolQuery, nodes []*Attribute, init func(*Attribute), assign func(*Attribute, *AttributeValueBool)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(attributevaluebool.FieldAttributeID)
	}
	query.Where(predicate.AttributeValueBool(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(attribute.AttributeValuesBoolColumn), fks...))
	}))
...
func (aq *AttributeQuery) loadAttributeVariantsString(ctx context.Context, query *AttributeVariantStringQuery, nodes []*Attribute, init func(*Attribute), assign func(*Attribute, *AttributeVariantString)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Attribute)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(attributevariantstring.FieldAttributeID)
	}
	query.Where(predicate.AttributeVariantString(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(attribute.AttributeVariantsStringColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (aq *AttributeQuery) loadAttributeVariantsNum(ctx context.Context, query *AttributeVariantNumQuery, nodes []*Attribute, init func(*Attribute), assign func(*Attribute, *AttributeVariantNum)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Attribute)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(attributevariantnum.FieldAttributeID)
	}
	query.Where(predicate.AttributeVariantNum(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(attribute.AttributeVariantsNumColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
