...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			attributevaluebool.Table:     attributevaluebool.ValidColumn,
			attributevaluenum.Table:      attributevaluenum.ValidColumn,
			attributevaluestring.Table:   attributevaluestring.ValidColumn,
			attributevariantnum.Table:    attributevariantnum.ValidColumn,
			attributevariantstring.Table: attributevariantstring.ValidColumn,
