...
const (
	// Label holds the string label denoting the attributevariantstring type in the database.
	Label = "attribute_variant_string"
	...
	// Table holds the table name of the attributevariantstring in the database.
	Table = "attribute_variant_strings"
	// AttributeTable is the table that holds the attribute relation/edge.
	AttributeTable = "attribute_variant_strings"
...
// Columns holds all SQL columns for attributevariantstring fields.
var Columns = []string{
	FieldID,
	FieldAttributeID,
	FieldValue,
...
// OrderOption defines the ordering options for the AttributeVariantString queries.
